 ...
 */
final class Version20210717113330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE external_service_call_result (id INT NOT NULL, called_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, url TEXT NOT NULL, status_code INT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
